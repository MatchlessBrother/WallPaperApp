package company.petrifaction.boss.widget;
...
public class ListDialog extends BaseDialog<ListDialog> {
    ...
    public ListDialog(Context context, ArrayList<DialogMenuItem> baseItems) {
        super(context);
        mContents.addAll(baseItems);
        init();
    }

    public ListDialog(Context context, String[] items) {
        super(context);
    ...
    public ListDialog(Context context, BaseAdapter adapter) {
        super(context);
        mAdapter = adapter;
        init();
    }
    ...
    public void setUiBeforShow() {
        ...
        if (mAdapter == null) {
            mAdapter = new ListDialog.ListDialogAdapter();
        }
     ...
     */
    public ListDialog titleBgColor(int titleBgColor) {
     ...
     */
    public ListDialog titleTextSize_SP(float titleTextSize_SP) {
     ...
     */
    public ListDialog titleTextColor(int titleTextColor) {
        mTitleTextColor = titleTextColor;
        return this;
    }

    /*** enable title show(设置标题是否显示) */
    public ListDialog isTitleShow(boolean isTitleShow) {
     ...
     */
    public ListDialog lvBgColor(int lvBgColor) {
     ...
     */
    public ListDialog cornerRadius(float cornerRadius_DP) {
     ...
     */
    public ListDialog dividerHeight(float dividerHeight_DP) {
     ...
     */
    public ListDialog itemPressColor(int itemPressColor) {
     ...
     */
    public ListDialog itemTextColor(int itemTextColor) {
     ...
     */
    public ListDialog itemTextSize(float itemTextSize_SP) {
     ...
     */
    public ListDialog setItemExtraPadding(int itemLeft, int itemTop, int itemRight, int itemBottom) {
     ...
     */
    public ListDialog layoutAnimation(LayoutAnimationController lac) {
        mLac = lac;
        return this;
    }
